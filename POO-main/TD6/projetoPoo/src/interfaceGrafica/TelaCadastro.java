...
public class TelaCadastro extends JFrame{
	...
	private void initialize() {
		...
		try {
            MaskFormatter maskFormatter = new MaskFormatter("###.###.###-##"); // Definindo a máscara
            textCpf = new JFormattedTextField(maskFormatter); // Usando JFormattedTextField com a máscara
        } catch (ParseException e) {
            e.printStackTrace();
            return;
        }
		
		textCpf.setBounds(247, 128, 170, 20);
		panel.add(textCpf);
		...
		try {
            MaskFormatter maskFormatter = new MaskFormatter("##/##/####"); // Definindo a máscara
            textDataNascimento = new JFormattedTextField(maskFormatter); // Usando JFormattedTextField com a máscara
        } catch (ParseException e) {
            e.printStackTrace();
            return;
        }
